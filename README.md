...
[![MBA](https://img.shields.io/badge/Degree-MBA-blue?style=flat)](#)
[![AI Transformation](https://img.shields.io/badge/Focus-AI%20Transformation-purple?style=flat)](#)
...
I'm a **Senior Program and Portfolio Manager** with an MBA and PMP certification, specializing in leading enterprise-scale **AI transformation initiatives**. I bridge the gap between technical AI capabilities and business strategy — translating complex AI concepts into executable roadmaps, governance frameworks, and measurable outcomes for organizations navigating the shift to AI-powered operations.

My work sits at the intersection of **program management excellence**, **AI adoption strategy**, and **responsible AI governance**. I'm passionate about helping organizations move from AI experimentation to sustained, scalable AI value.
